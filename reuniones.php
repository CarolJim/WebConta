    ...
    <div class="container pt-5">
      <div class="row pt-5 ">
        ...
        <div class="col-md-7 pb-5">
          <h1 class="text-bluedark">REUNIONES</h1>
          <p class="text-bluedark text-justify">
            El capital humano es la base de cualquier entidad económica, conocido también como Recursos Humanos, está compuesta de seres humanos que se unen para beneficio mutuo y la entidad económica se forma o se destruye por la calidad o el comportamiento de su gente. Lo que distingue a una empresa es la calidad del personal que posee habilidades para usar conocimientos de toda clase. Sólo a través de esta que los demás recursos se pueden utilizar con efectividad.
          </p>
          <ul class="text-bluedark">
            <li>Definir qué personal es el que requiere la organización.</li>
            <li>Reclutar y contratar a las personas más adecuadas para la empresa.</li>
            <li>Retener y lograr la permanencia de los mejores individuos en la organización.</li>
            <li>Conseguir que los trabajadores contribuyan a los objetivos de la empresa.</li>
            <li>Administración del personal suministrado.</li>
            <li>Desarrollar la eficiencia y eficacia del personal administrado.</li>
          </ul>
        </div>
